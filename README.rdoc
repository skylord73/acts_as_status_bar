...
When you launch status_bar_init in your controller, status_bar_id is nil so a new one is created,
stored in status_bar_id, and then passed to your view with your object.

You need to pass it back to your controller's create action using an hidden field.
